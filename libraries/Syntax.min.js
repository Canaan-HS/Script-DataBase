...
a[0],m=a.at(-1),n=f?.constructor===Object,t=m?.constructor===Object;if(t&&!n)b=m,c=a.slice(0,-1);else if(n&&!t)b=f,c=a.slice(1);else if(n&&t){const r=new Set(Object.keys(d));b=Object.keys(f).filter(v=>r.has(v)).length;Object.keys(m).filter(v=>r.has(v)).length>b?(b=m,c=a.slice(0,-1)):(b=f,c=a.slice(1))}}var {dev:e,group:h,collapsed:k}={...d,...b};if(!e||0===c.length)return new Proxy({},{get(){}});var l=f=>{"count"===f?H.count(c[0]):(f=H[f]||H.log,h?(k?console.groupCollapsed(h):console.group(h),f(...c),
console.groupEnd()):f(...c))},g=setTimeout(()=>l("log",c));return new Proxy({},{get(f,m){clearTimeout(g);l(m,c)}})}}async function Q(a,b,c=crypto.randomUUID(),d=!0){if(d||!I.has(c)){var e=document.getElementById(c);e||(e=document.createElement(a),e.id=c,(a=R.head)?a.appendChild(e):S("head").then(h=>{h.appendChild(e)}));e.textContent+=b;I.add(c)}}async function S(a,b=null,c={}){const d=Array.isArray(a)?T.queryMap:T.queryElement,{raf:e=!1,all:h=!1,timeout:k=8,throttle:l=0,debounce:g=50,visibility:f=
!0,subtree:m=!0,childList:n=!0,attributes:t=!0,characterData:r=!1,timeoutResult:v=!1,root:z=document}=c||{};return new Promise((p,q)=>{const u=async function(){let y,w;if(e){let A;const F=()=>{(w=d(a,h))?(cancelAnimationFrame(A),clearTimeout(y),b?.(w),p(w)):A=requestAnimationFrame(F)};A=requestAnimationFrame(F);y=setTimeout(()=>{cancelAnimationFrame(A);v&&(b?.(w),p(w))},1E3*k)}else{const [A,F]=0<l?[J,l]:[K,g],L=new MutationObserver(A(()=>{if(w=d(a,h))L.disconnect(),clearTimeout(y),b?.(w),p(w)},F));
L.observe(z,{subtree:m,childList:n,attributes:t,characterData:r});y=setTimeout(()=>{L.disconnect();v&&(b?.(w),p(w))},1E3*k)}};f&&"hidden"===document.visibilityState?document.addEventListener("visibilitychange",()=>u(),{once:!0}):u()})}function U(a,b,c,d){let e;return null!=c?V[B(c)](b,a,c):(e=b.getItem(a),void 0!=e?V[B(JSON.parse(e))](b,e):d)}function J(a,b){let c=0;return(...d)=>{const e=Date.now();e-c>=b&&(c=e,a(...d))}}function K(a,b){let c=null;return(...d)=>{clearTimeout(c);c=setTimeout(function(){a(...d)},
b)}}function W(a){a=new Blob([a],{type:"application/javascript"});const b=URL.createObjectURL(a),c=new Worker(b),d=c.terminate;c.terminate=function(){d.call(c);URL.revokeObjectURL(b)};return c}const Z=new DOMParser,B=a=>Object.prototype.toString.call(a).slice(8,-1);[Document.prototype,Element.prototype].forEach(a=>{a.$q=function(b){return x(this,b,!1)};a.$qa=function(b){return x(this,b,!0)}});const M={$text(a=null){return null===a?this?.textContent?.trim():this.textContent=a?.trim()??""},$copy(a=
...
createDomFragment:a=>document.createRange().createContextualFragment(a),get createFragment(){return document.createDocumentFragment()},title:(a=null)=>null===a?document.title:document.title=a,cookie:(a=null)=>null===a?document.cookie:document.cookie=a,createUrl:a=>URL.createObjectURL(a),_on:(a,b)=>{const c={};for(const d of Object.keys(b)){let e=b[d];e&&("function"===typeof e&&(e={listen:e}),e.listen&&(a.addEventListener(d,e.listen,e.add),c[d]=()=>a.removeEventListener(d,e.listen,e.add)))}return c},createElement(a,
b,c,d){const [e,h,k={},l="beforeend"]="string"===typeof a?[void 0,a,b,c]:[a,b,c,d];if(h){var {class:g,text:f="",rows:m,cols:n,on:t={},style:r={},attr:v={},...z}=k;a=document.createElement(h);a.textContent=f;g&&(a.className=g);void 0!==m&&(a.rowSpan=m);void 0!==n&&(a.colSpan=n);Object.assign(a,z);"string"===typeof r?a.style.cssText=r:Object.assign(a.style,r);for(const q in v)a.setAttribute(q,v[q]);var p="object"===typeof t&&0<Object.keys(t).length?this._on(a,t):{};Object.assign(a,{on(q,u,y){this.addEventListener(q,
u,y);Object.assign(p,{[q]:()=>this.removeEventListener(q,u,y)})},off(q){p[q]?.();delete p[q]},offAll(){Object.keys(p).forEach(q=>{p[q]();delete p[q]})}});return 1===e?.nodeType?e.insertAdjacentElement(l,a):a}}},D=new Map,H={log:(...a)=>console.log(...a),warn:(...a)=>console.warn(...a),table:(...a)=>console.table(...a),trace:(...a)=>console.trace(...a),debug:(...a)=>console.debug(...a),error:(...a)=>console.error(...a),count:a=>console.count(a)},I=new Set,G=new Map,T={queryMap:(a,b)=>{a=a.map(c=>x(document,
c,b));return b?a.every(c=>0<c.length)&&a:a.every(Boolean)&&a},queryElement:(a,b)=>{a=x(document,a,b);return(b?0<a.length:a)&&a}},V={String:(a,b,c)=>null!=c?(a.setItem(b,JSON.stringify(c)),!0):JSON.parse(b),Number:(a,b,c)=>null!=c?(a.setItem(b,JSON.stringify(c)),!0):Number(b),Array:(a,b,c)=>null!=c?(a.setItem(b,JSON.stringify(c)),!0):(b=JSON.parse(b),Array.isArray(b[0])?new Map(b):b),Object:(a,b,c)=>null!=c?(a.setItem(b,JSON.stringify(c)),!0):JSON.parse(b),Boolean:(a,b,c)=>null!=c?(a.setItem(b,JSON.stringify(c)),
!0):JSON.parse(b),Date:(a,b,c)=>null!=c?(a.setItem(b,JSON.stringify(c)),!0):new Date(b),Map:(a,b,c)=>(a.setItem(b,JSON.stringify([...c])),!0)},Y={Process:(a,b,c=null)=>{a=a[b.toLowerCase()];return"Function"===B(a)?a(c):a?a:"None"}},N={ko:"Korea","ko-KR":"Korea",ja:"Japan","ja-JP":"Japan",ru:"Russia","ru-RU":"Russia",en:"English","en-US":"English","en-GB":"English","en-AU":"English","en-CA":"English","en-NZ":"English","en-IE":"English","en-ZA":"English","en-IN":"English",zh:"Simplified","zh-CN":"Simplified",
"zh-SG":"Simplified","zh-MY":"Simplified","zh-TW":"Traditional","zh-HK":"Traditional","zh-MO":"Traditional"},C=new Set,O=a=>void 0===a||null===a?null:a,E=new Map;return function(...a){const b={};for(const c of a)c&&Object.defineProperties(b,Object.getOwnPropertyDescriptors(c));return b}({get sX(){return window.scrollX},get sY(){return window.scrollY},get iW(){return window.innerWidth},get iH(){return window.innerHeight},get platform(){let a;a=void 0!==navigator.userAgentData?.mobile?navigator.userAgentData.mobile?
"Mobile":"Desktop":window.matchMedia?.("(max-width: 767px), (pointer: coarse)")?.matches?"Mobile":/Android|webOS|iPhone|iPad|iPod|BlackBerry|IEMobile|Opera Mini/i.test(navigator.userAgent)?"Mobile":"Desktop";Object.defineProperty(this,"platform",{value:a,writable:!1});return a}},R,{addStyle:(a,b,c)=>Q("style",a,b,c),addScript:(a,b,c)=>Q("script",a,b,c),session:(a,{value:b=null,error:c}={})=>U(a,sessionStorage,b,c),local:(a,{value:b=null,error:c}={})=>U(a,localStorage,b,c),delV:a=>GM_deleteValue(a),
allV:()=>O(GM_listValues()),setV:(a,b)=>GM_setValue(a,b),getV:(a,b)=>O(GM_getValue(a,b)),setJV:(a,b,c=0)=>GM_setValue(a,JSON.stringify(b,null,c)),getJV(a,b){try{return JSON.parse(O(GM_getValue(a,b)))}catch{return b}},eventRecord:D,addRecord:I,observerRecord:G,$type:B,onE:async function(a,b,c,d={},e=null){try{"string"===typeof a&&(a=x(document,a));let h=b.split(/\s*[,|/]\s*/).filter(Boolean);if(0===h.length)throw Error("No event types provided");if(1===h.length)a.addEventListener(b,c,d);else{let k=
null;const l=g=>{clearTimeout(k);k=setTimeout(()=>c(g),15)};h.forEach(g=>a.addEventListener(g,l,d))}e?.(!0)}catch{e?.(!1)}},onEvent:async function(a,b,c,d={}){const {mark:e,...h}=d;"string"===typeof a&&(a=x(document,a));d=e??a;const k=D.get(d);k?.has(b)||(a.addEventListener(b,c,h),k||D.set(d,new Map),D.get(d).set(b,c))},offEvent:async function(a,b,c){"string"===typeof a&&(a=x(document,a));c=c??a;const d=D.get(c)?.get(b);d&&(a.removeEventListener(b,d),D.get(c).delete(b))},onUrlChange:function(a,b=
15){function c(m){clearTimeout(e);k||"urlchange"!==m||(k=!0);e=setTimeout(()=>{k&&d(!1,!0);a({type:m,url:location.href,domain:location.hostname})},Math.max(15,b))}function d(m=!0,n=!1){n&&h||(clearTimeout(e),history.pushState=l,history.replaceState=g,m&&window.removeEventListener("urlchange",f.urlchange),window.removeEventListener("popstate",f.popstate),window.removeEventListener("hashchange",f.hashchange),h=!0)}let e=null,h=!1,k=!1;const l=history.pushState,g=history.replaceState,f={urlchange:()=>
c("urlchange"),popstate:()=>c("popstate"),hashchange:()=>c("hashchange")};window.addEventListener("urlchange",f.urlchange);window.addEventListener("popstate",f.popstate);window.addEventListener("hashchange",f.hashchange);history.pushState=function(){l.apply(this,arguments);c("pushState")};history.replaceState=function(){g.apply(this,arguments);c("replacestate")};return{off:d}},log:P,createLog:function(a={}){return(...b)=>P(...b,a)},$observer:async function(a,b,c={},d=null){const {mark:e="",debounce:h=
0,throttle:k=100,subtree:l=!0,childList:g=!0,attributes:f=!0,characterData:m=!1}=c||{};if(e&&(c=G.get(e))){if(c.target===a)return;c.ob.disconnect();G.delete(e)}const [n,t]=0<h?[K,h]:[J,k];c={subtree:l,childList:g,attributes:f,characterData:m};const r=new MutationObserver(n(()=>{b()},t));r.observe(a,c);e&&G.set(e,{target:a,ob:r});d?.({ob:r,op:c})},waitEl:S,$throttle:J,$debounce:K,scopeParse:function(a,b){if("string"!==typeof a||""===a.trim())return b;const c=b.length;let d=!1;const e=new Set,h=new Set,
k=(g,f,m)=>{const n=g<=f;for(;n?g<=f:g>=f;n?g++:g--)m.add(g)};let l;for(l of a.split(/\s*[\.,|/]\s*/))if(/^(!|-)?\d+(~\d+|-\d+)?$/.test(l)){a=l.slice(1);const g=/^[!-]/.test(l),f=/[~-]/.test(a),[m,n]=g?[h,a]:(d=!0,[e,l]),[t,r]=f?n.split(/-|~/):[n,n];t===r?m.add(+t-1):k(+t-1,+r-1,m)}return(d?[...e]:[...b.keys()]).filter(g=>!h.has(g)&&g<c&&0<=g).sort((g,f)=>g-f).map(g=>b[g])},createWorker:W,formatTemplate:function(a,b){if("Object"!==B(a))return"Template must be an object";a=Object.fromEntries(Object.entries(a).map(([c,
d])=>[c.toLowerCase(),d]));return"String"===B(b)?b.replace(/\{\s*([^}\s]+)\s*\}/g,(c,d)=>Y.Process(a,d)):"Object"===B(b)?Object.entries(b).map(([c,d])=>Y.Process(a,c,d)):{"Unsupported format":b}},createCompressor:function(){let a=W('importScripts("https://cdn.jsdelivr.net/npm/fflate@0.8.2/umd/index.min.js");onmessage = function(e) {const { filesWithOptions } = e.data;const fileNames = Object.keys(filesWithOptions);let totalSize = 0;let processedSize = 0;fileNames.forEach(name => {totalSize += filesWithOptions[name].data.length;});const chunks = [];const zip = new fflate.Zip((err, data, final) => {if (err) {postMessage({ type: "error", error: err.message });return;}chunks.push(data);if (final) {let size = 0;let offset = 0;chunks.forEach(c => size += c.length);const zipped = new Uint8Array(size);chunks.forEach(c => {zipped.set(c, offset);offset += c.length;});postMessage({ type: "done", data: zipped }, [zipped.buffer]);}});(async () => {for (const name of fileNames) {const { data, level } = filesWithOptions[name];const fileStream = new fflate.ZipPassThrough(name, { level });zip.add(fileStream);fileStream.push(data, true);processedSize += data.length;postMessage({ type: "progress", loaded: processedSize, total: totalSize });} zip.end();})().catch(err => {postMessage({ type: "error", error: err.message });});}');
const b=new Set("mp4 mov avi mkv flv wmv webm mpg mpeg m4v ogv 3gp asf ts vob rm rmvb m2ts f4v mts zip rar 7z gz bz2 .pg jpeg png gif webp bmp tiff tif svg .eic heif raw ico psd mp3 aac flac wav ogg pdf".split(" "));let c={},d=[];return{async destroyWorker(){a&&(a.terminate(),a=null)},async file(e,h){const k=new Promise(async l=>{const g=await h.arrayBuffer();c[e]=new Uint8Array(g);l()});d.push(k);return k},async generateZip(e={},h){await Promise.all(d);return new Promise((k,l)=>{if(0===Object.keys(c).length)return l("Empty Data Error");
const g={};Object.entries(c).forEach(([f,m])=>{var n=f.split(".").pop().toLowerCase();n=b.has(n)?0:e.level||5;g[f]={data:m,level:n}});a.postMessage({filesWithOptions:g},Object.values(g).map(f=>f.data.buffer));a.onmessage=f=>{f=f.data;"progress"===f.type?h?.(f.loaded/f.total*100):"done"===f.type?(h?.(100),c={},d=[],k(new Blob([f.data],{type:"application/zip"}))):"error"===f.type&&(c={},d=[],l(f.error))}})}}},createNnetworkObserver:function(a={}){function b(){var p=Date.now();if(p-v<f)return z;v=p;
if(navigator.connection){const {effectiveType:q,saveData:u}=navigator.connection;z="4g"!==q||u?"3g"===q||"4g"===q&&u?"normal":"poor":"good"}else 5<=r.length&&(p=r.reduce((q,u)=>q+u,0)/r.length,z=p<h?"good":p>k?"poor":"normal");return z}let {MAX_Delay:c=2E3,MIN_CONCURRENCY:d=1,MAX_CONCURRENCY:e=16,Good_Network_THRESHOLD:h=500,Poor_Network_THRESHOLD:k=1500,adaptiveFactors:l={good:{delayFactor:.8,threadFactor:1.2},normal:{delayFactor:1,threadFactor:1},poor:{delayFactor:1.5,threadFactor:.7}},TIME_THRESHOLD:g=
1E3,Network_Check_Interval:f=1E4,EMA_ALPHA:m=.3,ADJUSTMENT_FACTOR:n=.25,History_Size:t=10}=a||{},{responseHistory:r=[],lastNetworkCheck:v=0,networkCondition:z="normal"}={};return function(p,q,u=null,y=0){p=Date.now()-p;r.push(p);r.length>t&&r.shift();g=!g||1>=r.length?p:m*p+(1-m)*g;g=Math.max(20,Math.min(2E3,g));const {delayFactor:w,threadFactor:A}=l[b()];p/=g;q=Math.max(y,Math.min(q*(1+(p-1)*n*w),c));return null!==u?[Math.round(q),Math.round(Math.max(d,Math.min(u*(1-(p-1)*n*A),e)))]:Math.round(q)}},
