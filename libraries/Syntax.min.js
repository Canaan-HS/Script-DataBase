...
// @license      MPL-2.0
// ==/UserScript==
const Lib=(()=>{function w(a=document,b,c){const d=b[0],e=b.slice(1);if(/[ .#:[\]>+~*,()^$=]/.test(e))return c?a.querySelectorAll(b):a.querySelector(b);if(!c&&"#"===d)return a.getElementById(e);if("."===b[0])return a=a.getElementsByClassName(e),c?[...a]:a[0];a=a.getElementsByTagName(b);return c?[...a]:a[0]}async function M(a,b,c=crypto.randomUUID(),d=!0){if(d||!N.has(c)){var e=document.getElementById(c);e||(e=document.createElement(a),e.id=c,(a=F.head)?a.appendChild(e):O("head").then(f=>{F.head=f;
f.appendChild(e)}));e.textContent+=b;N.add(c)}}async function O(a,b=null,c={}){const d=Array.isArray(a)?P.queryMap:P.queryElement,{raf:e=!1,all:f=!1,timeout:h=8,throttle:g=0,debounce:l=50,visibility:n=!0,subtree:k=!0,childList:q=!0,attributes:u=!0,characterData:t=!1,timeoutResult:y=!1,root:z=document}=c||{};return new Promise((m,r)=>{const p=async function(){let x,v;if(e){let A;const E=()=>{(v=d(a,f))?(cancelAnimationFrame(A),clearTimeout(x),b&&b(v),m(v)):A=requestAnimationFrame(E)};A=requestAnimationFrame(E);
x=setTimeout(()=>{cancelAnimationFrame(A);y&&(b&&b(v),m(v))},1E3*h)}else{const [A,E]=0<g?[G,g]:[H,l],I=new MutationObserver(A(()=>{if(v=d(a,f))I.disconnect(),clearTimeout(x),b&&b(v),m(v)},E));I.observe(z,{subtree:k,childList:q,attributes:u,characterData:t});x=setTimeout(()=>{I.disconnect();y&&(b&&b(v),m(v))},1E3*h)}};n&&"hidden"===document.visibilityState?document.addEventListener("visibilitychange",()=>p(),{once:!0}):p()})}function Q(a,b,c,d){let e;return null!=c?R[B(c)](b,a,c):(e=b.getItem(a),void 0!=
e?R[B(JSON.parse(e))](b,e):d)}function G(a,b){let c=0;return(...d)=>{const e=Date.now();e-c>=b&&(c=e,a(...d))}}function H(a,b){let c=null;return(...d)=>{clearTimeout(c);c=setTimeout(function(){a(...d)},b)}}function S(a){a=new Blob([a],{type:"application/javascript"});return new Worker(URL.createObjectURL(a))}const Y=new DOMParser,B=a=>Object.prototype.toString.call(a).slice(8,-1);[Document.prototype,Element.prototype].forEach(a=>{a.$q=function(b){return w(this,b,!1)};a.$qa=function(b){return w(this,
b,!0)}});const J={$text(a=null){return null!==a?this.textContent=a?.trim():this.textContent?.trim()},$copy(a=!0){return this.cloneNode(a)},$iHtml(a=null){return null!==a?this.innerHTML=a:this.innerHTML},$oHtml(a=null){return null!==a?this.outerHTML=a:this.outerHTML},$sAttr(a,b){this.setAttribute(a,b)},$dAttr(a){this.removeAttribute(a)},$gAttr(a){return this.getAttribute(a)},$hAttr(a){return this.hasAttribute(a)},$addClass(...a){this.classList.add(...a)},$delClass(...a){this.classList.remove(...a)},
