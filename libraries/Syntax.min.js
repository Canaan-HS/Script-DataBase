...
add:d})=>"string"===typeof b&&"function"===typeof c?(a.addEventListener(b,c,d),{[b]:()=>a.removeEventListener(b,c,d)}):{},createElement(a,b,c){const [d,e,h={}]="string"===typeof a?[null,a,b]:[a,b,c];if(e){var {id:f,title:g,class:k,text:l="",rows:p,cols:r,on:v={},style:t={},attr:A={},...y}=h,m=Object.assign(document.createElement(e),{textContent:l});f&&(m.id=f);g&&(m.title=g);k&&(m.className=k);void 0!==p&&(m.rowSpan=p);void 0!==r&&(m.colSpan=r);Object.assign(m,y);Object.assign(m.style,"string"===
typeof t?{cssText:t}:t);Object.entries(A).forEach(([n,x])=>m.setAttribute(n,x));var q={};Array.isArray(v)?v.forEach(n=>Object.assign(q,this._on(m,n))):"object"===typeof v&&Object.assign(q,this._on(m,v));Object.assign(m,{on(n,x,u){this.addEventListener(n,x,u);Object.assign(q,{[n]:()=>this.removeEventListener(n,x,u)})},off(n){q[n]?.();delete q[n]},offAll(){Object.keys(q).forEach(n=>{q[n]();delete q[n]})}});return 1===d?.nodeType?d.appendChild(m):m}}},D=new Map,W={log:a=>console.log(a),warn:a=>console.warn(a),
trace:a=>console.trace(a),error:a=>console.error(a),count:a=>console.count(a)},H=new Set,G=new Map,R={queryMap:(a,b)=>{a=a.map(c=>w(document,c,b));return b?a.every(c=>0<c.length)&&a:a.every(Boolean)&&a},queryElement:(a,b)=>{a=w(document,a,b);return(b?0<a.length:a)&&a}},T={String:(a,b,c)=>null!=c?(a.setItem(b,JSON.stringify(c)),!0):JSON.parse(b),Number:(a,b,c)=>null!=c?(a.setItem(b,JSON.stringify(c)),!0):Number(b),Array:(a,b,c)=>null!=c?(a.setItem(b,JSON.stringify(c)),!0):(b=JSON.parse(b),Array.isArray(b[0])?
new Map(b):b),Object:(a,b,c)=>null!=c?(a.setItem(b,JSON.stringify(c)),!0):JSON.parse(b),Boolean:(a,b,c)=>null!=c?(a.setItem(b,JSON.stringify(c)),!0):JSON.parse(b),Date:(a,b,c)=>null!=c?(a.setItem(b,JSON.stringify(c)),!0):new Date(b),Map:(a,b,c)=>(a.setItem(b,JSON.stringify([...c])),!0)},X={Process:(a,b,c=null)=>{a=a[b.toLowerCase()];return"Function"===B(a)?a(c):a?a:"None"}},N={ko:"Korea","ko-KR":"Korea",ja:"Japan","ja-JP":"Japan",ru:"Russia","ru-RU":"Russia",en:"English","en-US":"English","en-GB":"English",
"en-AU":"English","en-CA":"English","en-NZ":"English","en-IE":"English","en-ZA":"English","en-IN":"English",zh:"Simplified","zh-CN":"Simplified","zh-SG":"Simplified","zh-MY":"Simplified","zh-TW":"Traditional","zh-HK":"Traditional","zh-MO":"Traditional"},C=new Set,O=a=>void 0===a||null===a?null:a,E=new Map;return function(...a){const b={};for(const c of a)c&&Object.defineProperties(b,Object.getOwnPropertyDescriptors(c));return b}({get sX(){return window.scrollX},get sY(){return window.scrollY},get iW(){return window.innerWidth},
get iH(){return window.innerHeight},_cache:void 0,get platform(){this._cache||(void 0!==navigator.userAgentData?.mobile?this._cache=navigator.userAgentData.mobile?"Mobile":"Desktop":window.matchMedia?.("(max-width: 767px), (pointer: coarse)")?.matches?this._cache="Mobile":/Android|webOS|iPhone|iPad|iPod|BlackBerry|IEMobile|Opera Mini/i.test(navigator.userAgent)?this._cache="Mobile":this._cache="Desktop");return this._cache}},I,{addStyle:(a,b,c)=>P("style",a,b,c),addScript:(a,b,c)=>P("script",a,b,
c),session:(a,{value:b=null,error:c}={})=>S(a,sessionStorage,b,c),local:(a,{value:b=null,error:c}={})=>S(a,localStorage,b,c),delV:a=>GM_deleteValue(a),allV:()=>O(GM_listValues()),setV:(a,b)=>GM_setValue(a,b),getV:(a,b)=>O(GM_getValue(a,b)),setJV:(a,b,c=0)=>GM_setValue(a,JSON.stringify(b,null,c)),getJV(a,b){try{return JSON.parse(O(GM_getValue(a,b)))}catch{return b}},eventRecord:D,addRecord:H,observerRecord:G,$type:B,onE:async function(a,b,c,d={},e=null){try{"string"===typeof a&&(a=w(document,a));let h=
b.split(/\s*[,|/]\s*/).filter(Boolean);if(0===h.length)throw Error("No event types provided");if(1===h.length)a.addEventListener(b,c,d);else{let f=null;const g=k=>{clearTimeout(f);f=setTimeout(()=>c(k),15)};h.forEach(k=>a.addEventListener(k,g,d))}e?.(!0)}catch{e?.(!1)}},onEvent:async function(a,b,c,d={}){const {mark:e,...h}=d;"string"===typeof a&&(a=w(document,a));d=e??a;const f=D.get(d);f?.has(b)||(a.addEventListener(b,c,h),f||D.set(d,new Map),D.get(d).set(b,c))},offEvent:async function(a,b,c){"string"===
typeof a&&(a=w(document,a));c=c??a;const d=D.get(c)?.get(b);d&&(a.removeEventListener(b,d),D.get(c).delete(b))},onUrlChange:function(a,b=15){function c(p){clearTimeout(e);f||"urlchange"!==p||(f=!0);e=setTimeout(()=>{f&&d(!1,!0);a({type:p,url:location.href,domain:location.hostname})},Math.max(15,b))}function d(p=!0,r=!1){r&&h||(clearTimeout(e),history.pushState=g,history.replaceState=k,p&&window.removeEventListener("urlchange",l.urlchange),window.removeEventListener("popstate",l.popstate),window.removeEventListener("hashchange",
l.hashchange),h=!0)}let e=null,h=!1,f=!1;const g=history.pushState,k=history.replaceState,l={urlchange:()=>c("urlchange"),popstate:()=>c("popstate"),hashchange:()=>c("hashchange")};window.addEventListener("urlchange",l.urlchange);window.addEventListener("popstate",l.popstate);window.addEventListener("hashchange",l.hashchange);history.pushState=function(){g.apply(this,arguments);c("pushState")};history.replaceState=function(){k.apply(this,arguments);c("replacestate")};return{off:d}},log:async function(a=
null,b="print",{dev:c=!0,type:d="log",collapsed:e=!0}={}){c&&(c=W[d]||W.log,null==a?c(b):(e?console.groupCollapsed(a):console.group(a),c(b),console.groupEnd()))},$observer:async function(a,b,c={},d=null){const {mark:e="",debounce:h=0,throttle:f=100,subtree:g=!0,childList:k=!0,attributes:l=!0,characterData:p=!1}=c||{};if(e&&(c=G.get(e))){if(c.target===a)return;c.ob.disconnect();G.delete(e)}const [r,v]=0<h?[K,h]:[J,f];c={subtree:g,childList:k,attributes:l,characterData:p};const t=new MutationObserver(r(()=>
{b()},v));t.observe(a,c);e&&G.set(e,{target:a,ob:t});d?.({ob:t,op:c})},waitEl:Q,$throttle:J,$debounce:K,scopeParse:function(a,b){if("string"!==typeof a||""===a.trim())return b;const c=b.length,d=new Set,e=new Set,h=(g,k,l)=>{const p=g<=k;for(;p?g<=k:g>=k;p?g++:g--)l.add(g)};let f;for(f of a.split(/\s*[\.,|/]\s*/))if(/^(!|-)?\d+(~\d+|-\d+)?$/.test(f)){a=f.slice(1);const g=/^[!-]/.test(f),k=/[~-]/.test(a),[l,p]=g?[e,a]:[d,f],[r,v]=k?p.split(/-|~/):[p,p];r==v?l.add(+r-1):h(+r-1,+v-1,l)}return[...d].filter(g=>
!e.has(g)&&g<c&&0<=g).sort((g,k)=>g-k).map(g=>b[g])},createWorker:U,formatTemplate:function(a,b){if("Object"!==B(a))return"Template must be an object";a=Object.fromEntries(Object.entries(a).map(([c,d])=>[c.toLowerCase(),d]));return"String"===B(b)?b.replace(/\{\s*([^}\s]+)\s*\}/g,(c,d)=>X.Process(a,d)):"Object"===B(b)?Object.entries(b).map(([c,d])=>X.Process(a,c,d)):{"Unsupported format":b}},createCompressor:function(){let a=U('importScripts("https://cdn.jsdelivr.net/npm/fflate@0.8.2/umd/index.min.js");onmessage = function(e) {const { filesWithOptions } = e.data;const fileNames = Object.keys(filesWithOptions);let totalSize = 0;let processedSize = 0;fileNames.forEach(name => {totalSize += filesWithOptions[name].data.length;});const chunks = [];const zip = new fflate.Zip((err, data, final) => {if (err) {postMessage({ type: "error", error: err.message });return;}chunks.push(data);if (final) {let size = 0;let offset = 0;chunks.forEach(c => size += c.length);const zipped = new Uint8Array(size);chunks.forEach(c => {zipped.set(c, offset);offset += c.length;});postMessage({ type: "done", data: zipped }, [zipped.buffer]);}});(async () => {for (const name of fileNames) {const { data, level } = filesWithOptions[name];const fileStream = new fflate.ZipPassThrough(name, { level });zip.add(fileStream);fileStream.push(data, true);processedSize += data.length;postMessage({ type: "progress", loaded: processedSize, total: totalSize });}zip.end();})().catch(err => {postMessage({ type: "error", error: err.message });});}');
