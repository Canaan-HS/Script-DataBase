...
"en-GB":"English","en-AU":"English","en-CA":"English","en-NZ":"English","en-IE":"English","en-ZA":"English","en-IN":"English",zh:"Simplified","zh-CN":"Simplified","zh-SG":"Simplified","zh-MY":"Simplified","zh-TW":"Traditional","zh-HK":"Traditional","zh-MO":"Traditional"},L=new Set,M=a=>void 0===a||null===a?null:a;return function(...a){const b={};for(const c of a)c&&Object.defineProperties(b,Object.getOwnPropertyDescriptors(c));return b}({get sX(){return window.scrollX},get sY(){return window.scrollY},
...
c),AddScript:(a,b,c=!0)=>N("script",a,b,c),Session:(a,{value:b=null,error:c}={})=>Q(a,sessionStorage,b,c),Local:(a,{value:b=null,error:c}={})=>Q(a,localStorage,b,c),dV:a=>GM_deleteValue(a),aV:()=>M(GM_listValues()),sV:(a,b)=>GM_setValue(a,b),gV:(a,b)=>M(GM_getValue(a,b)),sJV:(a,b,c=0)=>GM_setValue(a,JSON.stringify(b,null,c)),gJV:(a,b)=>{try{return JSON.parse(M(GM_getValue(a,b)))}catch{return b}},Type:y,EventRecord:A,one:async function(a,b,c,d={},e=null){try{"string"===typeof a&&(a=t(document,a));
let g=b.split(/\s*[,|/]\s*/).filter(Boolean);if(0===g.length)throw Error("No event types provided");if(1===g.length)a.addEventListener(b,c,d);else{let f=null;const h=k=>{clearTimeout(f);f=setTimeout(()=>c(k),15)};g.forEach(k=>a.addEventListener(k,h,d))}e&&e(!0)}catch{e&&e(!1)}},onEvent:async function(a,b,c,d={}){const {mark:e,...g}=d;"string"===typeof a&&(a=t(document,a));d=e??a;const f=A.get(d);f?.has(b)||(a.addEventListener(b,c,g),f||A.set(d,new Map),A.get(d).set(b,c))},offEvent:async function(a,
b,c){"string"===typeof a&&(a=t(document,a));c=c??a;const d=A.get(c)?.get(b);d&&(a.removeEventListener(b,d),A.get(c).delete(b))},onUrlChange:function(a,b=15){function c(l){clearTimeout(e);f||"urlchange"!==l||(f=!0);e=setTimeout(()=>{f&&d(!1,!0);a({type:l,url:location.href,domain:location.hostname})},Math.max(15,b))}function d(l=!0,r=!1){r&&g||(clearTimeout(e),history.pushState=h,history.replaceState=k,l&&window.removeEventListener("urlchange",n.urlchange),window.removeEventListener("popstate",n.popstate),
window.removeEventListener("hashchange",n.hashchange),g=!0)}let e=null,g=!1,f=!1;const h=history.pushState,k=history.replaceState,n={urlchange:()=>c("urlchange"),popstate:()=>c("popstate"),hashchange:()=>c("hashchange")};window.addEventListener("urlchange",n.urlchange);window.addEventListener("popstate",n.popstate);window.addEventListener("hashchange",n.hashchange);history.pushState=function(){h.apply(this,arguments);c("pushState")};history.replaceState=function(){k.apply(this,arguments);c("replacestate")};
return{off:d}},Log:async function(a=null,b="print",{dev:c=!0,type:d="log",collapsed:e=!0}={}){c&&(c=T[d]||T.log,null==a?c(b):(e?console.groupCollapsed(a):console.group(a),c(b),console.groupEnd()))},Observer:async function(a,b,c={},d=null){const {mark:e="",debounce:g=0,throttle:f=100,subtree:h=!0,childList:k=!0,attributes:n=!0,characterData:l=!1}=c??{};if(e){if(D[e])return;D[e]=!0}const [r,u]=0<g?[H,g]:[G,f];c={subtree:h,childList:k,attributes:n,characterData:l};const x=new MutationObserver(r(()=>
{b()},u));x.observe(a,c);d&&d({ob:x,op:c})},WaitElem:O,Throttle:G,Debounce:H,ScopeParsing:function(a,b){if("string"!==typeof a||""===a.trim())return b;const c=b.length,d=new Set,e=new Set,g=(h,k,n)=>{const l=h<=k;for(;l?h<=k:h>=k;l?h++:h--)n.add(h)};let f;for(f of a.split(/\s*[\.,|/]\s*/))if(/^(!|-)?\d+(~\d+|-\d+)?$/.test(f)){a=f.slice(1);const h=/^[!-]/.test(f),k=/[~-]/.test(a),[n,l]=h?[e,a]:[d,f],[r,u]=k?l.split(/-|~/):[l,l];r==u?n.add(+r-1):g(+r-1,+u-1,n)}return[...d].filter(h=>!e.has(h)&&h<c&&
0<=h).sort((h,k)=>h-k).map(h=>b[h])},FormatTemplate:function(a,b){if("Object"!==y(a))return"Template must be an object";a=Object.fromEntries(Object.entries(a).map(([c,d])=>[c.toLowerCase(),d]));return"String"===y(b)?b.replace(/\{\s*([^}\s]+)\s*\}/g,(c,d)=>U.Process(a,d)):"Object"===y(b)?Object.entries(b).map(([c,d])=>U.Process(a,c,d)):{"Unsupported format":b}},OutputTXT:async function(a,b,c=null){try{b="string"!==typeof b?"Anonymous.txt":b.endsWith(".txt")?b:`${b}.txt`;const d=new Blob([a],{type:"text/plain"}),
e=document.createElement("a");e.href=URL.createObjectURL(d);e.download=b;e.click();URL.revokeObjectURL(e.href);e.remove();c&&c({State:!0})}catch(d){c&&c({State:!1,Info:d})}},OutputJson:async function(a,b,c=null){try{a="string"!==typeof a?JSON.stringify(a,null,4):a;b="string"!==typeof b?"Anonymous.json":b.endsWith(".json")?b:`${b}.json`;const d=new Blob([a],{type:"application/json"}),e=document.createElement("a");e.href=URL.createObjectURL(d);e.download=b;e.click();URL.revokeObjectURL(e.href);e.remove();
c&&c({State:!0})}catch(d){c&&c({State:!1,Info:d})}},Runtime:function(a=null,{lable:b="Elapsed Time:",log:c=!0,format:d=!0,style:e="\u001b[1m\u001b[36m%s\u001b[0m"}={}){if(!a)return performance.now();a=d?`${((performance.now()-a)/1E3).toPrecision(3)}s`:performance.now()-a;return c?console.log(e,`${b} ${a}`):a},GetDate:function(a=null){const b=new Date,c={year:b.getFullYear(),month:`${b.getMonth()+1}`.padStart(2,"0"),date:`${b.getDate()}`.padStart(2,"0"),hour:`${b.getHours()}`.padStart(2,"0"),minute:`${b.getMinutes()}`.padStart(2,
"0"),second:`${b.getSeconds()}`.padStart(2,"0")};return(d=>d.replace(/{([^}]+)}/g,(e,g)=>c[g]??"Error"))("string"===typeof a?a:"{year}-{month}-{date} {hour}:{minute}:{second}")},TranslMatcher:function(a,b=navigator.language,c="en-US"){return a[K[b]]??a[K[c]]??a[K["en-US"]]},Menu:function(a,b={}){let {name:c="Menu",index:d=1,reset:e=!1}=b??{};e&&([...L].map(g=>GM_unregisterMenuCommand(g)),L.clear());for(let [g,f]of Object.entries(a))a=`${c}-${d++}`,"function"===typeof f&&(f={func:f}),GM_registerMenuCommand(g,
()=>{f.func()},{id:a,title:f.desc,autoClose:f.close,accessKey:f.hotkey}),L.add(a)},StoreListen:async function(a,b){a.forEach(c=>{D[c]||(D[c]=!0,GM_addValueChangeListener(c,function(d,e,g,f){b({key:d,ov:e,nv:g,far:f})}))})},WorkerCreation(a){a=new Blob([a],{type:"application/javascript"});return new Worker(URL.createObjectURL(a))},Sleep:a=>new Promise(b=>setTimeout(b,a)),DomParse:a=>V.parseFromString(a,"text/html"),NameFilter:a=>a.replace(/[\/\?<>\\:\*\|":]/g,""),GetFill:a=>Math.max(2,`${a}`.length),
SuffixName(a,b="webp"){try{if(!a)return b;const c=new URL(a,location.href);a=/\.([^.]+)$/;return(c.pathname.match(a)?.[1]||c.search.match(a)?.[1])?.toLowerCase().trim()||b}catch{return b}},Mantissa(a,b,c="0",d=null){return d?`${++a}`.padStart(b,c)+`.${this.SuffixName(d)}`:`${++a}`.padStart(b,c)}})})();